...
python -m PyInstaller --noconfirm --onefile --windowed --name ExcelDataProcessor --add-data "config.yaml;." --hidden-import openpyxl --hidden-import openpyxl.cell._writer --hidden-import yaml --clean gui_launcher.py
